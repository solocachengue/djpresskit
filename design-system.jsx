...
const ICON_PATHS = {
  ...
  soundcloud: "M1 14.2h1.4v5.1H1zm2.9-2.4h1.4v7.5H3.9zm2.9-3.3h1.4v10.8H6.8zm2.9-2.6h1.4v13.4H9.7zm2.9 1.7h1.4v11.7h-1.4zm3.2-1.1c.4-.2.9-.3 1.4-.3 2.4 0 4.4 2 4.4 4.4s-2 4.4-4.4 4.4h-1.4V6.5z",
  beatport: "M12 0C5.37 0 0 5.37 0 12s5.37 12 12 12 12-5.37 12-12S18.63 0 12 0zm-1.2 5.4v6.9l4.2-3.3 2.1 2.7-4.5 3.5 4.5 3.5-2.1 2.7-4.2-3.3v2.5H7.5V5.4z",
